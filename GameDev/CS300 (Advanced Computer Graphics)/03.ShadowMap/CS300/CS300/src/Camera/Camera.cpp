...
Latitude(pi/2.0f), Azimuth(pi/2.0f), Radius(50.0f), View(glm::lookAt(GetCartesianPosition(), -GetCartesianPosition(), CameraUp))
{}

void Camera::UpdateView()
{
	View = glm::lookAt(GetCartesianPosition(), -GetCartesianPosition(), CameraUp);
}
