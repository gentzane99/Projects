...
#define g_aStar Singleton<A_Star>::GetInstance()
#define g_snakeGame Singleton<SnakeGame>::GetInstance()
#define g_QLearning Singleton<Q_Learning>::GetInstance()
...
static const float DEFAULT_SPEED = 0.0f;
