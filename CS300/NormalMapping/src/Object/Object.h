...
class Object
{
	...
	//Computes the average normals for the tangents and bitangents 
	std::vector<glm::vec3> ComputeAverageNormalsToDraw(const std::vector<glm::vec3>& rhs);
	...
	//Setter of precision and rings
	 ...
	 //Store tangents and bitangents
	 std::vector<glm::vec3> tangents;
	 std::vector<glm::vec3> bitangents;

	 //Tangents and bitangents VBO
	 GLuint TangentsBuffer;
	 GLuint BitangentsBuffer;

	 //Tangents and bitangents to draw
	 std::vector<glm::vec3> TangentsDraw;
	 std::vector<glm::vec3> BitangentsDraw;

	 //Tangents and bitangents VAO to draw
	 GLuint TangentsVAO;
	 GLuint BitangentsVAO;

	 //Tangents and bitangents VBO to draw
	 GLuint TangentsVBO;
	 GLuint BitangentsVBO;

	 //Render normals, tangents or bitangents
	 int RenderModeCount;
